...
export const route = {
  ...
  viewTeamMember: (teamId: number, memberId: number) =>
    `/dashboard/teams/${teamId}/members/${memberId}`,
  ...
  viewTeamProject: (teamId: number, projectId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}`,
  viewTasksOfTeamProject: (teamId: number, projectId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}/tasks`,
  viewProjectTask: (teamId: number, projectId: number, taskId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}/tasks/${taskId}`,
  addTeamProject: (teamId: number) => `/dashboard/teams/${teamId}/projects/create`,
  addTasksToTeamProject: (teamId: number, projectId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}/tasks/add`,
  deleteTeam: (teamId: number) => `/dashboard/teams/${teamId}/delete`,
  viewTeamMailSystem: (teamId: number) => `/dashboard/teams/${teamId}/mail`,
  updateTeamProject: (teamId: number, projectId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}/update`,
  deleteTeamProject: (teamId: number, projectId: number) =>
    `/dashboard/teams/${teamId}/projects/${projectId}/delete`,

  myInvitations: (status: Status = Status.Pending) =>
    status === Status.Pending
      ? `/dashboard/invitations`
      : `/dashboard/invitations/${status.toLowerCase()}`,
  ...
  assignedTeamTasksWithProject: (teamId: number, projectId: number) =>
    `/dashboard/assigned-tasks/teams/${teamId}?projectId=${projectId}`,
  assignedTeamTasksWithProjectWithStatus: (teamId: number, projectId: number, status: Status) =>
    `/dashboard/assigned-tasks/teams/${teamId}?projectId=${projectId}&status=${status}`,
}
